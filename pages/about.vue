<template>
  <article class="about">
    ...
    <section class="section">
      ...
      <p class="text">
        AWSの料金を最小限の入力で「ざっくり」計算できるサイトです。<br />入力の手間を減らすために料金への影響が少ない項目は削っているため、<br />見積もりなどで正確さを要求される場合は<ExternalLink
    ...
    <section class="section">
      ...
      <ul class="list">
        ...
        <li class="list-item">
          計算に日数が必要な場合は、ひと月を<em>{{ monthlyDate }}日</em>としています
        </li>
      </ul>
    </section>
    <section class="section">
      ...
      <section class="section-child">
        ...
        <p class="text">
          為替レートの取得には、<ExternalLink href="https://twitter.com/kujirahand">クジラ飛行机</ExternalLink
