  ...
  <ServiceTemplate service-name="elasticache">
    ...
    <section class="section">
      ...
      <section class="section-child">
        <h3 class="title-small">ノードタイプ</h3>
        <p class="text">利用する<ExternalLink href="https://aws.amazon.com/jp/elasticache/pricing/">ノードタイプ</ExternalLink>を選択してください。</p>
      </section>
    </section>
    <ServicePartsExclude>
      <section class="section-child">
        <h3 class="title-small">リザーブドノード</h3>
      ...
      <section class="section-child">
        ...
        <p class="text">1つのスナップショットのストレージ領域は無料で提供していますが、<ExternalLink href="https://aws.amazon.com/jp/elasticache/pricing/#%E3%83%90%E3%83%83%E3%82%AF%E3%82%A2%E3%83%83%E3%83%97%E3%82%B9%E3%83%88%E3%83%AC%E3%83%BC%E3%82%B8">追加のバックアップストレージ</ExternalLink>には別途料金がかかります。</p>
      </section>
      <section class="section-child">
        <h3 class="title-small">異なるAZ間のデータ転送</h3>
        <p class="text">同一リージョンの異なるAZにあるEC2の間でデータを転送する場合には、<ExternalLink href="https://aws.amazon.com/jp/elasticache/pricing/#%E3%83%87%E3%83%BC%E3%82%BF%E8%BB%A2%E9%80%81">データ転送料</ExternalLink>がかかります。同一AZでのデータ転送は無料です。</p>
      </section>
    </ServicePartsExclude>
  </ServiceTemplate>
</template>
