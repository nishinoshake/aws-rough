  ...
  <ServiceTemplate service-name="dynamodb">
    ...
    <template v-slot:disclaimer>
      <section class="section-child">
        ...
        <p class="text">
          RCUとWCUがある程度予測できる場合、最小使用量に対して割引を適用することができます。<br
            class="pc"
          />リザーブドキャパシティーを越えた分は、通常の料金が加算されます。
        </p>
      </section>
      <section class="section-child">
        <h3 class="title-small"><span>ストレージのオーバーヘッド</span></h3>
        <p class="text">
          ストレージコストには1アイテム当たり100bytesのオーバーヘッドが加算されます。<br
            class="pc"
          />アイテム数が億を超えるぐらいになると効いてきますが、その頃にはオーバーヘッドが気にならないぐらい高額になっていると思います。
        </p>
      </section>
      <section class="section-child">
