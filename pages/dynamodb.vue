  ...
  <ServiceTemplate service-name="dynamodb">
    <template v-slot:zakuri>
      <div class="section-child">
        ...
        <p class="text">
          リレーショナルじゃないデータは、DynamoDBに置いておけば、スケーラビリティに頭を抱えずに済みます。パフォーマンスやコストを最適化するためには慣れが必要なので、軽い気持ちで使うと後悔するかもしれません。事前のキャパシティ指定が不要なオンデマンドモードがサポートされたおかげで、だいぶ使いやすくなりました。
        </p>
        <p class="text">この要件、本当にDynamoDBで満たせるか？<br />と、使う前に何度も自問した方が良いです。</p>
      </div>
    </template>
