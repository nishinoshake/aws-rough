<template>
  <div class="landing">
    <div class="landing-poem">
      <p class="landing-poem-item">はじめてのAWS。<br />とりあえず入門書を読み進める。</p>
      <p class="landing-poem-item">
      ...
      <p class="landing-poem-item">
        ...
        <nuxt-link to="/elasticache/" class="mod-blue">ElastiCache</nuxt-link>でRedisを動かすことも検討してみよう。
      </p>

      <p class="landing-poem-item">
        詰め込み過ぎて頭が痛くなってきたけど、<br class="pc" />はじめてサーバーレスで設計してみたい気持ちもある。
      </p>
      <p class="landing-poem-item">
      ...
      <p class="landing-poem-item">
        次の課題はメールの送信。<br class="pc" />ひとまず<nuxt-link to="/sqs/" class="mod-beige">SQS</nuxt-link
      ...
      <p class="landing-poem-item">しかしこれ、一体いくらかかるんだ？</p>
    </div>
  </div>
</template>
